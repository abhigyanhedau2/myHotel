...
<head>
    ...
    <title>Booking Information - The Royal Palace</title>
...
<body>
    ...
    <main>
        <div class="main-container">
            <h1 id="main-heading">Booking Information</h1>
            <hr id="hr-line">
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Stay Duration (Days)</th>
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            echo "<tr>
                                    ...
                                    <td>" . $row['Gender'] . "</td>
                                    <td>" . $row['Aadhar Card Number'] . "</td>
                                    <td>" . $row['Date of Arrival'] . "</td>
                                    <td>" . $row['Number of Days'] . "</td>
                                    <td>" . $row['Number of Rooms'] . "</td>
                                    <td>" . $row['Room Type'] . "</td>
                                 </tr>";
